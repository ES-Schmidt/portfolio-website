...
export default function Header() {
	return (
		...
		<div className="mx-auto flex w-[min(1366px,100%)] grow items-stretch outline outline-1 outline-gray-100">
			<div className="flex basis-[61.8%] flex-col items-center justify-center bg-slate-900">
				<HeaderCard />
			</div>
			<HeaderGraphic />
		</div>
...
function HeaderCard() {
	return (
		<section className="relative left-[15%] flex max-h-[61.8%] min-h-fit w-[95%] flex-col justify-between bg-stone-900 px-[5%] py-[20%]">
			{/* introductory text */}
...
function HeaderGraphic() {
	return <div className="grow">{/* insert graphic into here */}</div>;
}
